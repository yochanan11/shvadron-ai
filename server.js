...
יש שני מסלולים חיים בזום, שעתיים בכל מפגש, עם הקלטות וקבוצת ליווי:
1) קורס הבסיס, 3 מפגשים: תאוריה בסיסית, פרומפטים, תמונות ומצגות, ופרויקט קטן שכל משתתף מוציא בעצמו. למי שמתחיל.
2) הקורס המורחב, 8 מפגשים: בסיס מקוצר, פרומפטים לעומק, בניית סוכנים, Custom GPTs, Google Gems, אוטומציות ו-Claude Code. למי שכבר נגע ורוצה מערכת שעובדת בשבילו.
...
- אם לא ברור לו איזה מסלול מתאים, שאל אם הוא כבר עובד עם AI היום: מי שלא, מתאים לקורס הבסיס. מי שכן, למורחב.
