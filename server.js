...
1) AI למתחילים, 3 מפגשים (6 שעות): לעבוד נכון עם AI ולהוציא ממנו תוצרים מקצועיים. ChatGPT ו-Gemini, 7 הכללים לכתיבת פרומפט, עבודה באיטרציות, NotebookLM ומקורות, הפיכת פגישה לסיכום החלטות משימות מסמך ומייל, ובניית מצגות מקצועיות. למי שמשתמש ב-AI אבל לא מרגיש ששולט בו.
2) AI למתקדמים, 9 מפגשים (18 שעות): לבנות באמצעות AI. שלושה תחומים: סוכני AI ו-Projects, אוטומציות עם Make (Forms, Google Sheets, Gmail, Google Calendar, Webhooks), ובניית תוכנות עם Claude Code ו-Codex ללא כתיבת קוד. בסיום כל תלמיד בונה פרויקט אישי. לא נדרש ידע בתכנות.
המחירים ומועדי המחזורים טרם פורסמו, וההרשמה נעשית בוואטסאפ ישירות מול יוחנן.
